...
public class LinkedPositionalList2<E> implements PositionalList<E> {
	...
	public LinkedPositionalList2(PLIteratorMaker<E> iterM) {
		header = new DNode<>(); 
		trailer = new DNode<>(); 
	...
	private DNode<E> validate(Position<E> p) throws IllegalArgumentException { 
		try { 
			...
			if (dp.getList()!=this)
				throw new IllegalArgumentException("Position not on the list.");
	...
	public E remove(Position<E> p) throws IllegalArgumentException {
		...
		if(dp==a||dp==b) throw new IllegalArgumentException("");
		b.setNext(a);
		a.setPrev(b);
		dp.clean(); 
		size--; 
	...
	public Iterable<Position<E>> backwardPositions() { 
